    ...
    return [
      {
        ...
        headers: [
          ...
          // CORS headers - Allow requests from same origin
          {
            ...
            value: process.env.NEXT_PUBLIC_APP_URL || 'https://sports-club-management.vercel.app'
          },
          {
          ...
          },
          {
            ...
            value: 'Content-Type, Authorization, X-Correlation-ID, X-Causation-ID'
          },
          {
      ...
      // API routes - stricter CSP for API endpoints
      {
        source: '/api/:path*',
        headers: [
          {
            key: 'Content-Security-Policy',
            value: "default-src 'none'; script-src 'none'; style-src 'none'; img-src 'none'; font-src 'none'; connect-src 'none'; frame-ancestors 'none'; base-uri 'none'; form-action 'none';"
          },
          {
            key: 'X-Content-Type-Options',
            value: 'nosniff'
